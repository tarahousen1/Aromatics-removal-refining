...
# Load Excel data
file_path = "/Users/tarahousen/Documents/Aromatics_removal_desulfurization_refining/excel_files/aromatics_saturation_efficiency.xlsx"
df = pd.read_excel(file_path, sheet_name='Sheet 1 - wpd_datasets(16)', header=1)
...
plt.xlabel("Temp")
plt.ylabel("Aromatics Saturation Efficiency")
plt.legend(title="Pressure")
plt.grid(True)
plt.tight_layout()
plt.savefig('outputs/aromatics_saturation_efficiency.png', dpi=300)


def interpolate_aromatics_saturation_efficiency(temp, pressure_feed):
